...
class Canvas(tkinter.Canvas):
    ...
    def create_text_area(self, x, y, width=200, height=100, text="",
                         color="black", bg="#ececec", font_size = 16, font="Helvetica"):
        """
        ...
        text_widget = tkinter.Text(frame, width=width, height=height, font=(font, font_size), foreground=color, bg=bg, wrap=tkinter.WORD)
